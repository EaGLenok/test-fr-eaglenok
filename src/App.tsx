        ...
        >
          {isFavoriteList &&
            favorite.map((product) => (
              <li key={product.id}>
                {product.title}
                <button onClick={() => deleteFromFavorite(+product.id)}>
                  X
                </button>
              </li>
            ))}
        ...
        <div className="container">
          <div className="footer__inner">
            ...
            >
              ...
              <li className="footer__item">
                <a href="#header">Checkout</a>
              </li>
              <li className="footer__item">
                <a href="#header">My Cart</a>
              </li>
              <li className="footer__item">
                <a href="#header">My catalog</a>
              </li>
            </ul>
